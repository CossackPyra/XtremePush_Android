...
public final class LocationDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity()).setMessage(R.string.location_providers_dialog_message)
                .setPositiveButton(R.string.location_providers_dialog_positive, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        getActivity().startActivityForResult(intent, LocationAccessHelper.START_LOCATION_ACTIVITY_CODE);
                    }
                }).create();
    }
}
